...
def main():
    ...
    st.sidebar.title("ManPasand Music Generator🎵")

    text_area = st.text_area("Enter your description to generate your own imagined music with your thoughts")
    time_slider = st.slider("Select time duration (In Seconds)", 0, 50, 10)
